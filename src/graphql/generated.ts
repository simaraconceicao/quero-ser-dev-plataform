...
export type EpisodeManyWhereInput = {
  ...
  /** All values ending with the given string. */
  episodeId_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  ...
  /** All values not ending with the given string */
  episodeId_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  episodeId_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
  /** All values not starting with the given string. */
  episodeId_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  episodeId_starts_with?: InputMaybe<Scalars['String']>;
  id?: InputMaybe<Scalars['ID']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']>;
  /** All values ending with the given string. */
...
export type ScheduledOperationAffectedDocument = Asset | Challenge | Episode | Lesson | Subscriber | Teacher;
